...
func main() {
	...
	log.Printf("Starting Bamse Bot token %s\n", apiToken)
	...
	*/
	...
	url, containsurl := containsWikiURL("aaa der hund ist da ")
	if containsurl {
		...
		if count > 0 {
			log.Printf("Der Artikel kommt mir doch sehr bekannt vor, ich denke den hatten wir schon!\n")
		} else {
			log.Printf("Den Artikel kannte ich noch garnicht! Hab ihn eingereicht!")
		}
	}
	/*
